...
export {}
declare global {
  const AssetSetter: typeof import('../../utils/AssetSetter')['AssetSetter']
  const CollisionChecker: typeof import('../../utils/CollisionChecker')['CollisionChecker']
  const Entity: typeof import('../../utils/Entity')['Entity']
  const KeyHandler: typeof import('../../utils/KeyHandler')['KeyHandler']
  const ObjObstacles: typeof import('../../utils/ObjObstacles')['ObjObstacles']
  const ObjPerson: typeof import('../../utils/ObjPerson')['ObjPerson']
  const Player: typeof import('../../utils/Player')['Player']
  const PlayersManager: typeof import('../../utils/PlayersManager')['PlayersManager']
  const SuperObject: typeof import('../../utils/SuperObject')['SuperObject']
  const Tile: typeof import('../../utils/Tile')['Tile']
  const TileManager: typeof import('../../utils/TileManager')['TileManager']
  const WebSocketService: typeof import('../../utils/WebSocketService')['WebSocketService']
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { AssetSetter } from '../../utils/AssetSetter'
  import('../../utils/AssetSetter')
  // @ts-ignore
  export type { CollisionChecker } from '../../utils/CollisionChecker'
  import('../../utils/CollisionChecker')
  // @ts-ignore
  export type { Entity } from '../../utils/Entity'
  import('../../utils/Entity')
  // @ts-ignore
  export type { KeyHandler } from '../../utils/KeyHandler'
  import('../../utils/KeyHandler')
  // @ts-ignore
  export type { ObjObstacles } from '../../utils/ObjObstacles'
  import('../../utils/ObjObstacles')
  // @ts-ignore
  export type { ObjPerson } from '../../utils/ObjPerson'
  import('../../utils/ObjPerson')
  // @ts-ignore
  export type { Player } from '../../utils/Player'
  import('../../utils/Player')
  // @ts-ignore
  export type { PlayersManager } from '../../utils/PlayersManager'
  import('../../utils/PlayersManager')
  // @ts-ignore
  export type { SuperObject } from '../../utils/SuperObject'
  import('../../utils/SuperObject')
  // @ts-ignore
  export type { Tile } from '../../utils/Tile'
  import('../../utils/Tile')
  // @ts-ignore
  export type { TileManager } from '../../utils/TileManager'
  import('../../utils/TileManager')
  // @ts-ignore
  export type { WebSocketService } from '../../utils/WebSocketService'
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly AssetSetter: UnwrapRef<typeof import('../../utils/AssetSetter')['AssetSetter']>
    readonly CollisionChecker: UnwrapRef<typeof import('../../utils/CollisionChecker')['CollisionChecker']>
    readonly Entity: UnwrapRef<typeof import('../../utils/Entity')['Entity']>
    readonly KeyHandler: UnwrapRef<typeof import('../../utils/KeyHandler')['KeyHandler']>
    readonly ObjObstacles: UnwrapRef<typeof import('../../utils/ObjObstacles')['ObjObstacles']>
    readonly ObjPerson: UnwrapRef<typeof import('../../utils/ObjPerson')['ObjPerson']>
    readonly Player: UnwrapRef<typeof import('../../utils/Player')['Player']>
    readonly PlayersManager: UnwrapRef<typeof import('../../utils/PlayersManager')['PlayersManager']>
    readonly SuperObject: UnwrapRef<typeof import('../../utils/SuperObject')['SuperObject']>
    readonly Tile: UnwrapRef<typeof import('../../utils/Tile')['Tile']>
    readonly TileManager: UnwrapRef<typeof import('../../utils/TileManager')['TileManager']>
    readonly WebSocketService: UnwrapRef<typeof import('../../utils/WebSocketService')['WebSocketService']>
